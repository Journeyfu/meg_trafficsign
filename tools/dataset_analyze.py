...
def select_data(cfg, args):
    use_local = args.use_local
    out_path = args.out_path

    if not use_local or not osp.isfile(out_path):
        print('--------重新获取数据---------')
        wh_all_data = collect_wh_data(cfg, args)
...
def statistics_hw_ratio(wh_all):
    ...
    plt.savefig("/data/Datasets/dataset-2805/vis/analyze/hw_ratio.jpg")
...
def statistics_hw_scale(wh_data):
    ...
    plt.savefig("/data/Datasets/dataset-2805/vis/analyze/hw_scale.jpg")
