...
#     return layer_keys
#
# weight_path = "/data/code/megengine-trafficsign/trafficdet/weights/R-50.pkl"
# weights = mge.load(weight_path)
# # weights = convert_basic_c2_names(weights)
# print(weights.keys())
# data = {k: v for k, v in data.items() if not k.endswith("_momentum")}
# _convert_ndarray_to_tensor(data)
...
# #     if "head" not in k:
# #         new_weights["backbone.bottom_up."+k] = v
# #     else:
# #         new_weights[k] = v
# #
# # mge.save(new_weights, "/data/code/megengine-trafficsign/trafficdet/weights/R-50.pkl")
#
...
#     """
#     Map Caffe2 Detectron weight names to Cvpack2 names.
#
#     Args:
#         weights (dict): name -> tensor
#
#     Returns:
#         dict: cvpack2 names -> tensor
#         dict: cvpack2 names -> C2 names
#     """
#     logger = logging.getLogger(__name__)
